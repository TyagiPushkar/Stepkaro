    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">Manage your product collections</p>
        </div>
      ...
      <div className="flex justify-between items-center">
        <p className="text-sm text-gray-400">
          Showing <span className="text-white">{filteredCollections.length > 0 ? startIndex + 1 : 0}</span> to{" "}
          <span className="text-white">{Math.min(endIndex, filteredCollections.length)}</span> of{" "}
          <span className="text-white">{filteredCollections.length}</span> collections
        </p>
                ...
                currentCollections.map((collection) => (
                  <tr key={collection.id} className="hover:bg-white/5 transition-colors">
                    <td className="px-6 py-4">
                      <span className="text-sm text-gray-300">#{collection.id}</span>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <span className="text-sm text-gray-400">{collection.createdAt}</span>
                    </td>
      ...
      <Modal isOpen={showAddModal} onClose={() => setShowAddModal(false)} title="Add New Collection">
        <div className="space-y-4">
          <div>
            <label className="text-sm text-gray-400 block mb-1">Collection Name *</label>
            <input
              type="text"
              value={formData.name}
          ...
          <div>
            <label className="text-sm text-gray-400 block mb-1">Collection Icon</label>
      ...
      <Modal isOpen={showViewModal} onClose={() => setShowViewModal(false)} title="Collection Details">
        {selectedCollection && (
          <div className="space-y-4">
            <div className="flex items-center gap-4 pb-4 border-b border-white/10">
              ...
              <div>
                <h3 className="text-lg font-semibold text-white">{selectedCollection.name}</h3>
                <p className="text-sm text-gray-400">Collection #{selectedCollection.id}</p>
              </div>
            </div>
            <div>
